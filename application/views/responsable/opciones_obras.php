...
<tr>
<td align="left"> <h2> <?php if($opcion_obras=="ver_todos") { echo 'Listado de obras'; } if($opcion_obras=="buscar") { echo 'Resultado de la búsqueda'; } ?> </h2> </td>
...
<div class="menu2">
<ul>
<li style="width:30%" <?php if($opcion_obras=="ver_todos") { echo 'id="primero"'; } ?>>
<a href="<?php echo base_url();?>index.php/responsable/obras/principal"> Ver todos </a>
</li>
</ul>
</div>
