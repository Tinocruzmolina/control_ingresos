...
class Ingresos extends CI_Controller {
  ...
  function index()
  {    
    redirect('administrador/ingresos/principal');			
  }
  ...
  function principal(){
	  try{	
		...
		$data['opcion_ingresos'] = 'ver_todos';	  
	  	$this->load->view('administrador/opciones_ingresos', $data);
		//$data['output'] = $output;
  ...
  function administracion(){
	...
	try{	
		...
		$data['nombre_usuario'] = $this->modelo->nombre_usuario($this->session->userdata('id_usuario'));
	  	$this->load->view('administrador/cabecera', $data);
		$data['opcion_ingresos'] = 'nuevo_ingreso';	  
	  	$this->load->view('administrador/opciones_ingresos', $data);
		//$data['output'] = $output;
		//$data['opcion_medios'] = 'ver_todos';	
		$this->load->view('grocery', $output);
